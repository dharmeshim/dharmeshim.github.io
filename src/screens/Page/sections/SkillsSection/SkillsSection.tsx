            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <h3 className={`${displayFont} font-bold ${primaryColor} text-3xl md:text-4xl lg:text-5xl tracking-tighter group-hover:text-blue-500 dark:group-hover:text-green-400 ${normalTransition} leading-none`}>
                    {skill.name}
                  </h3>

                  {skill.certification && (
                    <div className="space-y-3">
                      <p className={`${secondaryFont} font-bold ${accentColor} text-sm uppercase tracking-widest`}>
                ...
                <div className="space-y-3">
                  <div className={`flex items-center justify-between text-[10px] ${secondaryFont} uppercase tracking-widest text-gray-500 dark:text-gray-400`}>
                  ...
                  <div className="w-full bg-gray-200 h-1 rounded-full dark:bg-gray-700">
                    <div
                      className={`h-1 transition-all duration-700 rounded-full ${skill.certification
