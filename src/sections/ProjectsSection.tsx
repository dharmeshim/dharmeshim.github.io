                      ...
                      <div className="flex flex-wrap gap-3 lg:gap-4 pt-4 lg:pt-8 mt-auto">
                        {activeProject.sourceCode && (
                          <motion.a
                            ...
                            className="px-4 lg:px-6 py-2.5 lg:py-3 rounded-xl lg:rounded-2xl bg-white dark:bg-white/5 border border-gray-200 dark:border-gray-800 text-gray-900 dark:text-gray-100 text-sm lg:text-base font-mono font-medium flex items-center gap-2 lg:gap-3 transition-all shadow-sm hover:border-blue-500/30 dark:hover:border-green-400/30"
